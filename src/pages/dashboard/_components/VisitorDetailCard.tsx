...
export default function VisitorDetailCard({ visitor, pageViews }: Props) {
  return (
    <ScrollArea className="h-full">
      <div className="p-4 space-y-5">
        ...
        {/* Location — always shown, so it's obvious when we simply have no data yet */}
          ...
          <div className="space-y-1.5">
            ...
            {!visitor.city && !visitor.country && !visitor.ip && (
              <p className="text-xs text-muted-foreground/60">
                Location not available yet — resolves shortly after the visitor loads the widget.
              </p>
            )}
          </div>
        </div>
